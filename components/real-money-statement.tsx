  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <Reveal delay={100}>
          <h2
            className="mt-8 text-center font-black leading-[0.92] tracking-[-0.04em] text-white"
            style={{
          ...
          >
            ...
            <span className="block">
              Running <span className="text-white/55">now.</span>
            </span>
          </h2>
        </Reveal>

        <Reveal delay={200}>
          <p className="mx-auto mt-8 max-w-2xl text-center text-base leading-relaxed text-white/70 sm:text-lg">
