...
export function Billy() {
  return (
    <section
      id="billy"
      data-theme="dark"
      className="border-t border-white/10 bg-[#03070d] px-5 py-28 sm:px-8 sm:py-36"
    >
      <div className="mx-auto grid max-w-6xl items-center gap-14 md:grid-cols-2">
        <div>
          ...
          <Reveal delay={80}>
            <h2 className="mt-5 font-bold tracking-[-0.03em] text-white text-[clamp(2.25rem,5vw,3.5rem)] leading-[1.05]">
              Just ask.
              <br />
              <span className="text-white/55">Billy moves money.</span>
            </h2>
          </Reveal>
          <Reveal delay={160}>
          ...
          <Reveal delay={240}>
            <ul className="mt-7 flex flex-wrap gap-2">
              {[
                ...
                <li
                  key={q}
                  className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 text-xs font-medium text-white/85"
                >
                  {q}
                </li>
              ))}
        ...
        <Reveal delay={320}>
          <div className="mx-auto w-full max-w-[340px]">
            <div className="relative overflow-hidden rounded-[2.75rem] border border-white/10 bg-white/[0.04] p-1.5 shadow-2xl">
              <Image
