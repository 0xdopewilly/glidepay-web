  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <Reveal delay={80}>
          <h2 className="mt-5 max-w-3xl text-[clamp(2.25rem,5vw,3.5rem)] font-bold tracking-[-0.03em] text-white">
            What it actually <span className="text-white/55">looks like.</span>
          </h2>
        </Reveal>
        <Reveal delay={160}>
          ...
          {SCREENS.map((s, i) => (
            <Reveal key={s.src} delay={i * 90}>
              <figure className="flex h-full flex-col">
                <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.03] p-1.5">
                  <Image
                    src={s.src}
